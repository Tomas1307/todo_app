...
CREATE TABLE IF NOT EXISTS tasks (
    ...
    status VARCHAR(20) NOT NULL DEFAULT 'Sin Empezar',
...
BEGIN
    ...
    IF (SELECT COUNT(*) FROM tasks) = 0 THEN
        ...
        ('Configurar servidor de producción', NOW(), '2025-08-25 17:00:00', 'Sin Empezar', 1, 1),
        ('Revisar código del equipo', NOW(), '2025-08-20 14:00:00', 'Empezada', 1, 1),
        ('Documentar API REST', NOW(), '2025-08-22 16:00:00', 'Sin Empezar', 1, 6),
        ('Terminar informe mensual', NOW(), '2025-08-20 17:00:00', 'Sin Empezar', 2, 1),
        ('Reunión con cliente XYZ', NOW(), '2025-08-18 14:00:00', 'Sin Empezar', 2, 1),
        ('Estudiar Docker y Kubernetes', NOW(), '2025-08-19 20:00:00', 'Empezada', 2, 3),
        ('Comprar víveres para la semana', NOW(), '2025-08-16 18:00:00', 'Finalizada', 2, 5),
        ('Cita con el dentista', NOW(), '2025-08-19 09:00:00', 'Sin Empezar', 3, 4),
        ('Ejercicio matutino - Correr', NOW(), '2025-08-17 07:00:00', 'Finalizada', 3, 4),
        ('Organizar documentos importantes', NOW(), '2025-08-21 15:00:00', 'Sin Empezar', 3, 2),
        ('Aprender PostgreSQL avanzado', NOW(), '2025-08-24 19:00:00', 'Sin Empezar', 3, 3),
        ('Probar API de TODO', NOW(), '2025-08-18 12:00:00', 'Empezada', 4, 6),
        ('Crear presentación del proyecto', NOW(), '2025-08-23 16:00:00', 'Sin Empezar', 4, 1);
